...
export function OnboardingPopup({ onClose }: OnboardingPopupProps) {
  ...
  return (
    <div className="onboarding-screen" role="dialog" aria-modal="true" aria-labelledby="onboarding-title">
      <div className="onboarding-scroll">
        ...
        <section className="onboarding-section">
          <h2 className="onboarding-section-title">세차가 <span>해야 할</span> 때</h2>
          <ul className="onboarding-list">
            ...
            <li>
              <strong>새 배설물·벌레 사체·나무 수액</strong>이 묻었을 때 — 하루 이상 방치하면
              도장면에 <strong>얼룩·부식</strong>으로 남기 쉽습니다.
            </li>
            <li>
            ...
            <li>
              <strong>미세먼지·꽃가루</strong>가 차체에 달라붙기 시작했을 때 — 맑아 보여도
              닦을수록 <strong>지저분해지는</strong> 경우가 많습니다.
            </li>
          </ul>
        </section>

        <section className="onboarding-section">
          <h2 className="onboarding-section-title">세차 <span>미루는</span> 게 나은 때</h2>
          <p className="onboarding-lead">
            앞으로 3일 동안 차에 엉겨붙을 이물질(비·먼지·꽃가루)이 없어야, 세차 효과가 오래
            갑니다.
          </p>
          ...
          <ul className="onboarding-list">
            ...
            <li>
              <strong>미세먼지·황사</strong>가 나쁠 때 — 닦은 직후 공기 중 입자가 다시 달라붙어
              청결 유지 시간이 짧아집니다.
            </li>
            <li>
              <strong>꽃가루 위험지수</strong>가 높을 때 — 꽃가루가 수분·먼지와{" "}
              <strong>엉겨</strong> 외장에 박히면 일반 세차만으로 잘 안 지워집니다.
            </li>
          </ul>
        </section>
